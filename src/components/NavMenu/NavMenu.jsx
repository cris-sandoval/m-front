...
import "./navmenu.css"
import Kilua from "../../image/kilua.png"

export default function NavMenu({handleRender}) {
  return (
    <nav>
      <div className="profile">
        <div className="img-text-container">
          <img className='kilua' src={Kilua} alt="img-profile" />
        ...
        <div className="a-links">
          <a className='anchorNmenu' href="">Home</a>
          <a className='anchorNmenu' href="">Mangas</a>
          <a className='anchorNmenu' href="">My Mangas</a>
          <a className='anchorNmenu' href="">Favourites</a>
          <a className='anchorNmenu' href="">Logout</a>
        </div>
      </div>
    </nav>
  )
